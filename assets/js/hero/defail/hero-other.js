var championInfo = {
    ...
    appsAPIURI: "http://apps.game.qq.com/lol/api/v2013/",
    init: function () {
        var self = championInfo;
    ...
    userParamsbyRequest: function (callback) {
        ...
        if (array) {
            var heroId = array[1];
            if (app.hero.params.hero.champion.data[heroId]) {
                self.heroId = app.hero.params.hero.champion.data[heroId].key;
                self.heroName = app.hero.params.hero.champion.data[heroId].title;
                self.loadUserinfo();
                self.loadMeida();
                return;
            }
